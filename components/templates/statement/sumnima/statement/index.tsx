        ...
        <div className={classes.header}>
          <Group mb={-2} pl="1.05in" pr=".1in" justify="space-between">
            ...
            <Text {..._defaultTextProps}>
              {moment(form.values?.statement_start_date).format("DD/MM/YYYY")}
            </Text>
            <Text {..._defaultTextProps} fw={600}>
              to
            </Text>
            <Text {..._defaultTextProps}>
              {" "}
              {moment(form.values?.statement_end_date).format("DD/MM/YYYY")}
            </Text>
          </Group>
        </div>
        <Space h=".2in" />
            ...
            <table className={classes.st_table}>
              ...
              <tbody>
                {index == 0 && (
                  <tr>
                    <td style={{}}>
                      {moment(form.values?.statements_opening_date).format(
                        "YYYY/MM/DD"
                      )}
                    </td>
              ...
              <>
                ...
                <Grid gutter={0}>
                  ...
                  <Grid.Col span={3.25} ta="center">
                    <Text ta="center" {..._defaultTextProps} fw={600}>
                      {moment(form.values?.statement_end_date).add("1","day").format(
                        "DD/MM/YYYY"
                      )}
                    </Text>
                  </Grid.Col>
        ...
        {chunkedStatements[chunkedStatements.length - 1]?.length >= 32 && (
          ...
          >
            ...
            <Grid gutter={0}>
              ...
              <Grid.Col span={3.25} ta="center">
                <Text ta="center" {..._defaultTextProps} fw={600}>
                  {moment(form.values?.statement_end_date).add("1","day").format("DD/MM/YYYY")}
                </Text>
              </Grid.Col>
            </Grid>
