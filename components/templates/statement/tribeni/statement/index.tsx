          ...
          <Grid.Col span={12}>
            <Text size="xl" td="underline" ta="center">
              <b>
                ...
                {moment(form.values?.statement_start_date).format("YYYY/MM/DD")}{" "}
                To{" "}
                {moment(form.values?.statement_end_date).format("YYYY/MM/DD")}
              </b>
            </Text>
          </Grid.Col>
          <Grid.Col span={2}>
      ...
      <>
        <tr>
          <td style={{ fontVariantNumeric: "tabular-nums" }}>
            {moment(form.values?.statements_opening_date).format("DD-MM-YYYY")}
          </td>
